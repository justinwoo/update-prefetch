...
(function($PS) {
  ...
  var TarballUpdate = (function () {
      function TarballUpdate(value0) {
          this.value0 = value0;
      };
      TarballUpdate.create = function (value0) {
          return new TarballUpdate(value0);
      };
      return TarballUpdate;
  })();
  var GitHub = (function () {
  ...
  var Tarball = (function () {
      function Tarball(value0) {
          this.value0 = value0;
      };
      Tarball.create = function (value0) {
          return new Tarball(value0);
      };
      return Tarball;
  })();
  ...
  var match = function (path) {
      return function (pairs) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
              ...
              var $135 = Data_Eq.eq(Data_Eq.eqString)(path);
              return function ($136) {
  ...
  var makeAttrSet = function (v) {
      ...
      if (v instanceof TarballUpdate) {
          return new FormatNix.AttrSet([ new FormatNix.Bind(new FormatNix.AttrPath("name"), FormatNix.StringValue.create(Data_Show.show(Data_Show.showString)(v.value0.name))), new FormatNix.Bind(new FormatNix.AttrPath("url"), FormatNix.StringValue.create(Data_Show.show(Data_Show.showString)(v.value0.url))), new FormatNix.Bind(new FormatNix.AttrPath("sha256"), FormatNix.StringValue.create(Data_Show.show(Data_Show.showString)(v.value0.sha256))) ]);
      };
      throw new Error("Failed pattern match at Update (line 73, column 1 - line 73, column 30): " + [ v.constructor.name ]);
  };
  var immediate = function (dictApplicative) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Update (line 125, column 1 - line 125, column 75): " + [ f.constructor.name, v.constructor.name ]);
          };
      };
  };
  var getUpdate = function (v) {
      ...
      if (v instanceof Tarball) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("updating Tarball fetch: " + v.value0.url))(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_String_Common.trim)(runCommand({
                  cmd: "nix-prefetch-url",
                  args: [ v.value0.url, "--unpack" ]
              })))(function (v1) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(new TarballUpdate({
                      name: v.value0.name,
                      url: v.value0.url,
                      sha256: v1
                  }));
      ...
      throw new Error("Failed pattern match at Update (line 49, column 1 - line 49, column 37): " + [ v.constructor.name ]);
  };
  ...
  var readFetchType = function (attrs) {
      var v = function (v1) {
          var v2 = function (v3) {
              var v4 = function (v5) {
                  ...
                  throw new Error("Failed pattern match at Update (line 27, column 1 - line 27, column 47): " + [ attrs.constructor.name ]);
              };
              var $107 = 3 === Data_Array.length(attrs);
              if ($107) {
                  var $108 = Data_Array.mapMaybe(getBind)(attrs);
                  var $109 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("name")($108));
                  if ($109 instanceof Data_Maybe.Just) {
                      var $110 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("url")($108));
                      if ($110 instanceof Data_Maybe.Just) {
                          var $111 = match("sha256")($108);
                          return Data_Maybe.Just.create(new Tarball({
                              name: $109.value0,
                              url: $110.value0
                          }));
                      };
          ...
          var $115 = 2 === Data_Array.length(attrs);
          if ($115) {
              var $116 = Data_Array.mapMaybe(getBind)(attrs);
              var $117 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("url")($116));
              if ($117 instanceof Data_Maybe.Just) {
                  var $118 = match("sha256")($116);
      ...
      var $121 = 4 === Data_Array.length(attrs);
      if ($121) {
          var $122 = Data_Array.mapMaybe(getBind)(attrs);
          var $123 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("owner")($122));
          if ($123 instanceof Data_Maybe.Just) {
              var $124 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("repo")($122));
              if ($124 instanceof Data_Maybe.Just) {
                  var $125 = match("rev")($122);
                  var $126 = match("sha256")($122);
  ...
  var updateFetchAttrs = function (v) {
      ...
      if (v instanceof FormatNix.AttrSet) {
          var $131 = readFetchType(v.value0);
          if ($131 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Effect_Aff.bindAff)(getUpdate($131.value0))(function (v2) {
...
(function($PS) {
  ...
  var processExit = (function () {
      ...
      return function ($21) {
          return $20($foreign["_processExit"]($21));
      };
  })();
  var parser = FormatNix.mkParser(FormatNix.nixLanguage);
  var runUpdate = function (fileName) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("Processing file: " + fileName))(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(fileName))(function (v) {
              var root = FormatNix.rootNode(FormatNix.parse(parser)(v));
              ...
              if (eNodes instanceof Data_Either.Right) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Data_Traversable["for"](Effect_Aff.applicativeAff)(Data_Traversable.traversableArray)(eNodes.value0)(function (node) {
                      ...
                      var output = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(Data_Functor.map(Data_Functor.functorArray)(FormatNix.printExpr)(v1));
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(fileName)(output))(function () {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Sunde.spawn({
                              cmd: "which",
                              args: [ "nixpkgs-fmt" ],
                              stdin: Data_Maybe.Nothing.value
                          })(Node_ChildProcess.defaultSpawnOptions))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                                  if (v2.exit instanceof Node_ChildProcess.Normally && v2.exit.value0 === 0) {
                                      var args = [ fileName ];
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Sunde.spawn({
                                          cmd: "nixpkgs-fmt",
                                          args: args,
                                          stdin: Data_Maybe.Nothing.value
                                      })(Node_ChildProcess.defaultSpawnOptions))(function (v3) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("ran nixpkgs-fmt:"))(function () {
                                              return Effect_Class_Console.error(Effect_Aff.monadEffectAff)(v3.stderr);
                                          });
                                      });
                                  };
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
                              })())(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("updated " + (fileName + ".")))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Right(Success.value));
                                  });
                              });
                          });
                      });
              ...
              if (eNodes instanceof Data_Either.Left) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("encountered errors in parsing input file " + fileName))(function () {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Left(Failed.value));
                  });
              };
              throw new Error("Failed pattern match at Main (line 58, column 3 - line 82, column 25): " + [ eNodes.constructor.name ]);
          });
      });
  };
  var needFileArg = "\x0aYou must provide an argument for an expression file(s) to read and write to.\x0a\x0aE.g. update-prefetch my-expression.nix\x0a";
  var main = Effect_Aff.launchAff_((function () {
      var files = Data_Array.drop(2)($foreign.argv);
      var $15 = Data_Array["null"](files);
      if ($15) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)(needFileArg))(function () {
              return processExit(1);
          });
      };
      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(runUpdate)(files))(function (v) {
          var v1 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(v);
          ...
          throw new Error("Failed pattern match at Main (line 41, column 7 - line 45, column 24): " + [ v1.constructor.name ]);
      });
  })());
