...
(function($PS) {
  ...
  var match = function (path) {
      return function (pairs) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
              ...
              var $133 = Data_Eq.eq(Data_Eq.eqString)(path);
              return function ($134) {
                  return $133((function (v) {
                      return v.path;
                  })($134));
              };
          })())(pairs));
  ...
  var immediate = function (dictApplicative) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Update (line 127, column 1 - line 127, column 75): " + [ f.constructor.name, v.constructor.name ]);
          };
      };
  };
  ...
  var readFetchType = function (attrs) {
      var v = function (v1) {
          var v2 = function (v3) {
              ...
              var $106 = 3 === Data_Array.length(attrs);
              if ($106) {
                  var $107 = Data_Array.mapMaybe(getBind)(attrs);
                  var $108 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("name")($107));
                  if ($108 instanceof Data_Maybe.Just) {
                      var $109 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("url")($107));
                      if ($109 instanceof Data_Maybe.Just) {
                          var $110 = match("sha256")($107);
          ...
          var $114 = 2 === Data_Array.length(attrs);
          if ($114) {
              var $115 = Data_Array.mapMaybe(getBind)(attrs);
              var $116 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("url")($115));
              if ($116 instanceof Data_Maybe.Just) {
                  var $117 = match("sha256")($115);
      ...
      var $120 = 4 === Data_Array.length(attrs);
      if ($120) {
          var $121 = Data_Array.mapMaybe(getBind)(attrs);
          var $122 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("owner")($121));
          if ($122 instanceof Data_Maybe.Just) {
              var $123 = Data_Functor.map(Data_Maybe.functorMaybe)(stripQuotes)(match("repo")($121));
              if ($123 instanceof Data_Maybe.Just) {
                  var $124 = match("rev")($121);
                  var $125 = match("sha256")($121);
  ...
  var updateFetchAttrs = function (v) {
      if (v instanceof FormatNix.AttrSet) {
          ...
          throw new Error("Failed pattern match at Update (line 119, column 3 - line 124, column 27): " + [ v1.constructor.name ]);
      };
  ...
  exports["TarballUpdate"] = TarballUpdate;
...
(function($PS) {
  ...
  var runUpdate = function (fileName) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(fileName))(function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 38, column 3 - line 49, column 20): " + [ eNodes.constructor.name ]);
      });
  };
  ...
  var main = Effect_Aff.launchAff_((function () {
      ...
      throw new Error("Failed pattern match at Main (line 29, column 3 - line 31, column 40): " + [ v.constructor.name ]);
  })());
